...
<body>
	...
	//out.print(ctx);
	String targetUrl = ctx + "/candidate-update";
	%>

	<header>
		<h3>Candidate Details Update</h3>
		<button class="logout-button">
			<a href="landing-page">Go to Home</a>
	</header>

	<form:form modelAttribute="candidate" action="<%=targetUrl%>"
		method="post" enctype="multipart/form-data">

		<form:hidden path="candidateId" />
		<form:hidden path="partyName" />
		<form:hidden path="partyManifesto" />
		...
		<form:input path="idProof" type="file" />
		<br />

		<label for="candidateProfilePic">Profile Picture:</label>
		<form:input path="candidateProfilePic" type="file" />
		<br />
