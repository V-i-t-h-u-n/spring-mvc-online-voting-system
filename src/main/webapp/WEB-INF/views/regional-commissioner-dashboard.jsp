...
<title>Regional Commissioner Dashboard</title>
<style>
body {
...
<%
	...
	<header>
		...
		<button class="logout-button" id = "logoutButton"><a href= "<%=home%>">
			Logout</a></button>
	</header>
	...
	<div class="container">
		<div class="widget">
			<div>
				...
				<a href="profile" class="card-button">Go to Profile</a>
			</div>
			<div>
			...
			<div>
				...
				<a href="add-new-election/add-election" class="card-button">Add
					New Election</a>
			</div>
			<div>
			...
			<div>
				...
				<a href="add-new-election/add-party" class="card-button">Add New
					Party</a>
			</div>
			<div>
...
<!-- <div class="container">
        <div class="widget">
            ...
            <p><a href="candidate-approval">Candidate Approval</a></p>
            <p><a href="voter-approval">Voter Approval</a></p>
            <p><a href="add-new-election/add-election">Add Election</a></p>
            <p><a href="add-new-election/add-party">Add Party</a></p>
            <p><a href="voting-result-page"> See All Election Results </a></p>
